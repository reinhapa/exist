 ...
 * @author Adam Retter
 * */
public class InTxnLocalXPathQueryService extends LocalXPathQueryService {
    public InTxnLocalXPathQueryService(final Subject user, final BrokerPool pool, final LocalCollection collection) {
