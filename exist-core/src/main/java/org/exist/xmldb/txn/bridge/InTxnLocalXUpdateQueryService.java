 ...
 * @author Adam Retter
 */
public class InTxnLocalXUpdateQueryService extends LocalXUpdateQueryService {
    public InTxnLocalXUpdateQueryService(final Subject user, final BrokerPool pool, final LocalCollection parent) {
